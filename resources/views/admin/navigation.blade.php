        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('admin.user.view')">
                            {{ __('Administrar Usuarios') }}
                        </x-dropdown-link>

                        <x-dropdown-link :href="route('user.principal')">
                            {{ __('Acceder a la Tienda') }}
                        </x-dropdown-link>
...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 block sm:hidden">
    <div class="flex justify-between items-center px-4 py-3"> <!-- Ajustamos el padding y los elementos flexibles -->
        <!-- Logo -->
        <div class="shrink-0">
            <a href="{{ route('admin.principal') }}">
                <img src="{{ asset('assets/logo.png') }}" width="100" height="200" x="0" y="0" />
    ...
    <div :class="{'block': open, 'hidden': !open}" class="hidden sm:hidden">
        <div class="px-2 pt-2 pb-3 space-y-1"> <!-- Ajustamos el padding y el espacio entre elementos -->
            <x-nav-link :href="route('admin.product.index')" :active="request()->routeIs('admin.product.index')">
                {{ __('Gestionar Productos') }}
            </x-nav-link>
        ...
        <div class="border-t border-gray-200 pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('admin.user.view')">
                {{ __('Administrar Usuarios') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('user.principal')">
                {{ __('Acceder a la Tienda') }}
            </x-responsive-nav-link>
