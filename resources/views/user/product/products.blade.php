...
<body>
    <x-app-layout>
        <div class="container mt-4">
            ...
            <div id="productListContainer" class="d-flex flex-wrap justify-content-center">
                @include('user.product.busqueda', ['products' => $products])
            </div>
    ...
    <script>
        $(document).ready(function() {
            function realizarBusquedaYFiltrar(page = 1) {
            ...
            // Listener para los enlaces de paginación
            $(document).on('click', '.pagination a', function(event) {
                event.preventDefault();
                var page = $(this).attr('href').split('page=')[1];
                realizarBusquedaYFiltrar(page);
            });
